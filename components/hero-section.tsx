    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden cyber-grid">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-24">
        <div className="text-center">
          <div
            className={`mb-6 md:mb-10 transition-all duration-1000 ${mounted ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
          >
            <Image
          ...
          <h1
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl font-bold mb-6 md:mb-8 transition-all duration-700 delay-100 ${
              mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <span className="text-[#f0f0f5]">We </span>
            <GlitchText text="Empower" className="text-[#f5b800] text-glow" autoGlitch glitchInterval={6000} />
            <span className="text-[#f0f0f5]">.</span>
            <br />
            <span className="text-[#f0f0f5]">We </span>
            <GlitchText text="Deliver" className="text-[#f5b800] text-glow" autoGlitch glitchInterval={8000} />
            <span className="text-[#f0f0f5]">.</span>
          </h1>
          ...
          >
            ...
            >
              <span className="relative z-10 group-hover:text-glow-sm transition-all">View Solutions</span>
          ...
          {/* Stats with animated counters - Mobile responsive */}
          <div
          ...
          >
            {[
              ...
              <div key={index} className="text-center group">
                <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#f5b800] mb-2 md:mb-3 group-hover:text-glow transition-all">
                  <AnimatedCounter end={stat.value} suffix={stat.suffix} duration={2000 + index * 200} />
                </p>
                <p className="text-xs sm:text-sm md:text-base lg:text-lg text-[#888899]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
